...
class LiveScore_Model:
    ...
    def _decrease_both_ab(self, ability_json, current_score):
        ...
        try:
            ...
            cond_2 = all([True if ab_sec['has_event'] not in ['AT', 'DAN', 'DAT', 'SONT', 'SWW', 'DFK', 'FK'] else False for ab_sec in lookback_ab_20s])
    ...
    def _determine_various_cases(self, event_dictionary, current_score):
        ...
        :param event_dictionary: we determine according to the current event dictionary
    ...
    def predict_expected_ability(self, input_api_json):
        ...
        current_score = {'period': timer['LivePeriod'],
