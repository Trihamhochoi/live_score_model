...
class Engine:
    ...
    def get_AB_timer_metadata(self, isFT=True, is_live: bool = True):
        if self.metadata is None:
            ...
            self.metadata = {'meta': final_data, 'match_league': js_admin['matchLeague']}
        else:
            final_data = self.metadata['meta']

        # -- TIMER --
        # Get starting time
        match_details = self.metadata['match_league']
        ...
        final_data.update(l_timer)

        return match_details, final_data
